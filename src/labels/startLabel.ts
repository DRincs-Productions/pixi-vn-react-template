...
const startLabel = newLabel(
    ...
    [
        async () => {
            ...
            narration.dialogue = {
                character: james,
                text: `<div>You're my roommate's replacement, huh?</div><div></div><div><div><div>You're my roommate's replacement, huh?</div></div></div><div>You're my roommate's replacement, huh?</div><div>You're my roommate's replacement, huh?</div>`,
            };
        },
        async () => {
