...
import { getChannelSoundStore, setChannelVolume, toggleChannelMuted } from "../stores/createChannelSoundStore";
...
export default function SoundChannelControl({ label, alias, disabled, helper }: Props) {
    const store = useMemo(() => getChannelSoundStore(alias), [alias]);
